...
_Switches_ do not assign IP addresses, but do send data fbetween devices based on defined static IP addresses, or DHCP addresses defined by the network's _router_.
...
_Clients are an antenna for receiving a Wi-Fi network.
