...
1.  Waterfall, having a rigid plan with milestones. The _V-model_ is once example of Waterfall development.
...
Lockheed Martin's Skunk Works® has designed and build prototype planes in 2 year design cycles for the past 70 years, long before Agile was defined.
...
1.  **Concept of Operations (ConOps)**
    ...
    - How will the system be shipped, deployed, operated, maintained, and retired? (full lice cycle)
