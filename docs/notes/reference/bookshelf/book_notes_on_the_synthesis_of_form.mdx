...
<BookQuote
  quote={[
    "Two minutes with a pencil on the back of an envelope let's us solve problems which we would could not do in our heads of we tried for a hundred years. ",
...
<BookQuote
  quote={[
    ...
    "Plainly these have different degrees of significance, because the second is part of the first, well the first is not part of the second. "
  ]}
  page="113"
/>
