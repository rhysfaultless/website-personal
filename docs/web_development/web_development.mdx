...
Robots are starting to inculde User Interfaces to monitor and control them.
These interfaces act as a brigde between User intentions, and the backend robotics control language (ROS, Python, C++, etc)

:::note

Refer to the [Software](/docs/software/overview_software) section for more details of robotics controls programming.
