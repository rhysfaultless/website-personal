...
Robotics engineering requires a bredth of knowledge and processes for hardware and software design, manufacturing, and use.
...
6.  Networking and data busses (Etherner IP and router configurations, USB-Serial adapters, USB-CAN adapers)
